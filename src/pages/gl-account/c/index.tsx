...
import FormGLAccount from '@/components/organisms/GLAcc/Form/create';
...
const CreateGLAccounts = ({tokens}: GLAccountsProps) => {
    return (
        <>
...
export default CreateGLAccounts